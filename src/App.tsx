...
import './App.css';
import CardWithModuleCss from "./Card/CardWithModuleCss";
import CardWithStyledComponent from "./Card/CardWithStyledComponent";
import CardWithRegularCss from "./Card/CardWithRegularCss";
import HooksFlow from "./HooksFlow";
				...
				<div className="header_section">
					<div className="container">
						<div className="containt_main">
							...
							<span className="toggle_icon" onClick={() => setIsOpen(true)}>
                  <img src={toggleIcon}/>
                </span>
